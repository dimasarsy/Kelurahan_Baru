            ...
            <div class="pcss3t pcss3t-effect-scale pcss3t-theme-1">
                ...
                <ul>
                    <li class="tab-content tab-content-first typography">
                        ...
                        <a href="<?= base_url('layanan/surat_ktp') ?>"
                    ...
                    <li class="tab-content tab-content-2 typography">
                        <h2>Pendaftaran Kartu Keluarga</h2><br>

                        <a href="<?= base_url('layanan/surat_kK') ?>"
                            class="btn btn-success btn-fill pull-right" style="margin-top: -25px"><i class="fa fa-plus"
                                aria-hidden="true"></i>
                            <href> Tambah
                        </a><br>
                    ...
                    <li class="tab-content tab-content-3 typography">
                        ...
                        <a href="<?= base_url('layanan/surat_sktm') ?>"
                            class="btn btn-success btn-fill pull-right" style="margin-top: -25px"><i class="fa fa-plus"
                                aria-hidden="true"></i>
                            <href> Tambah
                        </a><br>
                    ...
                    <li class="tab-content tab-content-4 typography">
                        ...
                        <a href="<?= base_url('layanan/surat_domisili') ?>"
                            class="btn btn-success btn-fill pull-right" style="margin-top: -25px"><i class="fa fa-plus"
                                aria-hidden="true"></i>
                            <href> Tambah
                        </a><br>
                        ...
                        <table id="domisili" class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <?php if($v->status>=2):?>
                                    <td>
                                        <a href="<?=base_url("layanan/detail/domisili/$v->id")?>" class="btn btn-info"
                                            title="Lihat"><i class="fas fa-eye"></i></a>

                                        <a href="<?=base_url("layanan/cetak/domisili/".$_SESSION['nik']."/$v->id")?>"
                                            target="_blank" class="btn btn-warning" title="Cetak"><i
                                                class="fas fa-print"></i></a>
                    ...
                    <li class="tab-content tab-content-5 typography">
                        ...
                        <a href="<?= base_url('layanan/surat_pindah') ?>"
                            class="btn btn-success btn-fill pull-right" style="margin-top: -25px"><i class="fa fa-plus"
                                aria-hidden="true"></i>
                            <href> Tambah
                        </a><br>
                    ...
                    <li class="tab-content tab-content-6 typography">
                        ...
                        <a href="<?= base_url('layanan/surat_skck') ?>"
                            class="btn btn-success btn-fill pull-right" style="margin-top: -25px"><i class="fa fa-plus"
                                aria-hidden="true"></i>
                            <href> Tambah
                        </a><br>
                    ...
                    <li class="tab-content tab-content-7 typography">
                        ...
                        <a href="<?= base_url('layanan/surat_kelahiran') ?>"
                            class="btn btn-success btn-fill pull-right" style="margin-top: -25px"><i class="fa fa-plus"
                                aria-hidden="true"></i>
                            <href> Tambah
                        </a><br>
                    ...
                    <li class="tab-content tab-content-8 typography">
                        ...
                        <a href="<?= base_url('layanan/surat_kematian') ?>"
                            class="btn btn-success btn-fill pull-right" style="margin-top: -25px"><i class="fa fa-plus"
                                aria-hidden="true"></i>
                            <href> Tambah
                        </a><br>
