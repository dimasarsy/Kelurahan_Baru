<div class="container">
    <div class="container position-relative zindex-5 text-center pt-5 mt-lg-4 mt-xl-5 surat">
        <h3 class="display-1"><span class="text-black fw-normal">PEMBUATAN KTP</span></h3>
    </div>
</div>

<form id="regForm" method="post" action="<?= base_url('layanan/in_surat_ktp'); ?>" enctype="multipart/form-data">
    <div id="container">
        <div id="label">
            <h4>Persyaratan</h4>
        </div>
        <div class="tab">
            <div class="syarat">
                ...
                <ol>
                    ...
                    <li>Pas Foto 2x3
                        <ul>
                            <li> Background merah untuk tahun kelahiran ganjil</li>
                            <li> Background biru untuk tahun kelahiran genap</li>
                        </ul>
                    </li>
                    <li>Syarat Tambahan untuk Pergantian KTP
                        <ul>
                            <li> Fotokopi KTP Lama </li>
                            <li> Pergantian KTP karena hilang dilampiri pengantar kehilangan dari Polres </li>
                            <li> Pergantian KTP karena merubah status perkawinan dilampiri dengan fotokopi buku nikah
                            </li>
                        </ul>
                    </li><br>
    ...
    <div id="container">
        ...
        <div class="tab">
            ...
            <div class="mb-3">
                <label for="formFileMultiple" class="form-label">Fotokopi Kartu Keluarga <span class="text-danger">
                        *</span> </label>
                <input class="form-control" type="file" accept=".jpg, .png, .jpeg, .pdf" name="kk_file" requiredd
                    multiple>
            </div>
            <div class="mb-3">
                <label for="formFileMultiple" class="form-label">Fotokopi Akte Kelahiran <span class="text-danger">
                        *</span> </label>
                <input class="form-control" type="file" accept=".jpg, .png, .jpeg, .pdf" name="akte_file" requiredd
                    multiple>
            </div>
            <div class="mb-3">
                <label for="formFileMultiple" class="form-label">Pas Foto 2x3 <span class="text-danger">
                        *</span> </label>
                <input class="form-control" type="file" accept=".jpg, .png, .jpeg, .pdf" name="foto_file" requiredd
                    multiple>
            </div>
            <div class="mb-3">
                <label for="formFileMultiple" class="form-label">Syarat Tambahan <span class="text-danger">
                        * ( Pergantian KTP )
                    </span></label>
                <input class="form-control" type="file" accept=".jpg, .png, .jpeg, .pdf" name="tambahan_file" multiple>
            </div>
        </div>
