<div class="container">
    <div class="container position-relative zindex-5 text-center pt-5 mt-lg-4 mt-xl-5 surat">
        <h3 class="display-1"><span class="text-black fw-normal">REGISTER KK</span></h3>
    </div>
</div>

<form id="regForm" method="post" action="<?= base_url('layanan/in_surat_kk'); ?>" enctype="multipart/form-data">
    <div id="container">
        <div id="label">
            <h4>Persyaratan</h4>
        </div>
        <div class="tab">
            <div class="syarat">
                ...
                <ol>
                    ...
                    <li>Berkas (pilih salah satu):
                        <ul>
                            <li> KTP = Berusia 17 tahun</li>
                            <li> Keterangan Menikah = Pernah menikah jika berusia di bawah 17 tahun </li>
                        </ul>
                    </li>
                    <li>Kartu Keluarga</li>
                    <li>Syarat Tambahan untuk:
                        <ul>
                            <li> Perpanjangan = Upload KTP Lama (Asli)</li>
                            <li> Hilang = Surat Ket. Kehilangan dari Kepolisian </li>
                        </ul>
                    </li><br>
    ...
    <div id="container">
        ...
        <div class="tab">
            ...
            <div class="mb-3">
                <label for="formFileMultiple" class="form-label">KTP / Buku Nikah <span class="text-danger">
                        *</span> </label>
