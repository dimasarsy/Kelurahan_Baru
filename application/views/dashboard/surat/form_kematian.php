                                ...
                                <div class="content">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input class="form-control" type="text" name="nik" placeholder="NIK"
                                            ...
                                            required>
                                        <label for="floatingInput" class="control-label">NIK Pemohon<span
                                                class="text-danger">*</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input class="form-control" type="text" name="name" placeholder="name"
                                            value="<?=$hasil->name?>" required>
                                        <label for="floatingInput" class="control-label">Nama Pemohon<span
                                                class="text-danger">*</label>
                                    </div>
                                    ...
                                    <div class="form-floating mb-3">
                                        ...
                                        <label for="floatingSelect" class="control-label">Hubungan Keluarga <span
                                                class="text-danger">*</label>
                                    </div>

                                    <div class="form-floating mb-3">
                                        <input class="form-control" type="text" name="mayit" placeholder="Nama Mayit"
                                            value="<?=$hasil->mayit?>" required>
                                        <label for="floatingInput">Nama Mayit <span class="text-danger">*</label>
                                    </div>
                                    ...
                                    <div class="row g-2">
                                        ...
                                        <div class="col-md">
                                            <div class="form-floating">
                                                ...
                                                <input class="form-control" type="date" name="tgl_meninggal"
                                                    value="<?=date_format($tanggal, 'Y-m-d')?>" required>
                                                <label for="floatingInputGrid">Tanggal Meninggal <span
                                                        class="text-danger">*</span> </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md">
                                            <div class="form-floating mb-3">
                                                <input class="form-control" type="text" name="tempat_meninggal"
                                                    placeholder="Tempat Meninggal" value="<?=$hasil->tempat_meninggal?>"
                                                    required>
                                                <label for="floatingInput">Tempat Meninggal <span
                                                        class="text-danger">*</label>
                                            </div>
                                        </div>
                                    </div>
