                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="content">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input class="form-control" type="text" name="anak" placeholder="Nama Anak"
                                            value="<?=$hasil->anak?>" required>
                                        <label for="floatingInput">Nama Anak <span class="text-danger">*</label>
                                    </div>
