    ...
    <div class="modal-dialog">
        <div class="modal-content" id="signature-pad">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" id="nik" value="<?=$_SESSION['nik']?>">
            ...
            <div class="modal-footer clearfix">
                <button type="submit" id="save2" class="btn btn-success" data-action="save"><i class="fa fa-check"></i>
                    Save</button>
                <button type="button" data-action="clear" class="btn btn-secondary"><i class="fa fa-trash-o"></i>
                    Clear</button>
...
<!-- Modal -->
<div class="modal fade" id="dataDiriModal" tabindex="-1" role="dialog" aria-labelledby="dataDiriModalTitle"
    aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="" method="post" id="formAnggota">
                    <div class="row">
                        <div class="col-md-6">
                            <label for="" class="control-label modal-label">Nama Lengkap<span
                                    class="text-danger">*</span> </label>
                            <input class="form-control" type="text" name="m_nama" id="m_nama" title="Isi Nama Lengkap"
                                required>
                        </div>
                        <div class="col-md-6">
                            <label for="" class="control-label modal-label">NIK<span class="text-danger">*</span>
                            </label>
                            <input class="form-control" type="text" name="m_nik" id="m_nik" title="Isi NIK" required>
                        </div>
                        <div class="col-md-6">
                            <label for="" class="control-label modal-label">Tempat Lahir<span
                                    class="text-danger">*</span> </label>
                            <input class="form-control" type="text" name="m_tempat" id="m_tempat"
                                title="Isi Tempat Lahir" required>
                        </div>
                        <div class="col-md-6">
                            <label for="" class="control-label modal-label">Tanggal Lahir<span
                                    class="text-danger">*</span> </label>
                            <input class="form-control" type="date" name="m_tgl" id="m_tgl" title="Isi Tanggal Lahir"
                                required>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="" class="control-label modal-label">Jenis Kelamin <span
                                    class="text-danger">*</span> </label>
                        ...
                        <div class="form-group col-md-6">
                            <label for="" class="control-label modal-label">Pendidikan <span
                                    class="text-danger">*</span> </label>
                ...
                foreach ($pendidikan as $v => $c){
                  echo "<option value='$v'>$c</option>";
                        ...
                        <div class="form-group col-md-6">
                            <label for="" class="control-label modal-label">Golongan Darah <span
                                    class="text-danger">*</span> </label>
                ...
                foreach ($goldar as $v => $c){
                  echo "<option value='$v'>$c</option>";
                        ...
                        <div class="form-group col-md-6">
                            <label for="" class="control-label modal-label">Status Kawin <span
                                    class="text-danger">*</span> </label>
                ...
                foreach ($perkawinan as $v => $c){
                  echo "<option value='$v'>$c</option>";
                        ...
                        <div class="form-group col-md-6">
                            <label for="" class="control-label modal-label">Agama<span class="text-danger">*</span>
                            </label>
                ...
                foreach ($agama as $v => $c){
                  echo "<option value='$v'>$c</option>";
                        ...
                        <div class="form-group col-md-6">
                            <label for="" class="control-label modal-label">Pekerjaan<span class="text-danger">*</span>
                            </label>
                            <select class="form-control" name="m_pekerjaan" id="m_pekerjaan" title="Isi Pekerjaan"
                                required>
                                <?php
                $pekerjaan = PEKERJAAN;
                foreach ($pekerjaan as $v => $c){
                  echo "<option value='$v'>$c</option>";
                        ...
                        <div class="form-group col-md-4">
                            <label for="" class="control-label modal-label">Hubungan <span class="text-danger">*</span>
                            </label>
                            <input class="form-control" list="hubungan" name="m_hubungan" id="m_hubungan"
                                title="Isi Hubungan Keluarga" required>
                        ...
                        <div class="form-group col-md-4">
                            <label for="" class="control-label modal-label">Nama Ibu<span class="text-danger">*</span>
                            </label>
                            <input class="form-control" type="text" name="m_ibu" id="m_ibu" title="Isi Nama Ayah"
                                required>
                        </div>
                        <div class="form-group col-md-4">
                            <label for="" class="control-label modal-label">Nama Ayah<span class="text-danger">*</span>
                            </label>
                            <input class="form-control" type="text" name="m_ayah" id="m_ayah" title="Isi Nama Ibu"
                                required>
                        </div>
                    </div>
                </form>
...
<!-- Modal -->
<div class="modal fade" id="modalhapus" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    aria-hidden="true">
...
<!-- Modal Tanggapan -->
<div class="modal fade" id="modaltanggapan" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <?php
      ...
      echo form_open_multipart(base_url("admin/pengaduan/tanggapan/$id"),array('class' => 'form-horizontal')); ?>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <label for="" class="control-label modal-label">Tanggapan <span class="text-danger">*</span>
                        </label>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary btn-fill" data-dismiss="modal">Tidak</button>
                <button type="submit" name="tanggapan" class="btn btn-danger btn-fill text-white"
                    id="btnyakin">Yakin</a>
            </div>
            <?php echo form_close() ?>
        </div>
...
<!-- Modal Catatan -->
<div class="modal fade" id="modalCatatan" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <form class="" action="<?=base_url("admin/")?>" method="post" id="formCatatan">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <label for="" class="control-label modal-label">Catatan <span class="text-danger">*</span>
                            </label>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary btn-fill" data-dismiss="modal">Tidak</button>
                    <button name="tanggapan" type="submit" class="btn btn-danger btn-fill text-white"
                        id="btnyakins">Yakin</a>
                </div>
            </form>
        </div>
    </div>
...
<!-- Modal Kegiatan -->
<div class="modal fade" id="modalKegiatan" tabindex="-1" role="dialog" aria-labelledby="dataDiriModalTitle"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <select class="form-control" name="bidang" title="Pilih Bidang" required>
                            <option value="2.1-PENYELENGGARAAN PEMERINTAHAN DESA">PENYELENGGARAAN PEMERINTAHAN DESA
                            </option>
                  ...
                  ?>
                    ...
                    <div class="col-md-6">
                        <label for="" class="control-label modal-label">Tgl Mulai <span class="text-danger">*</span>
                        </label>
                        <input class="form-control" type="date" name="tgl_mulai" title="Isi Tanggal Mulai" required>
                    </div>
                    <div class="col-md-6">
                        <label for="" class="control-label modal-label">Tgl Selesai <span class="text-danger">*</span>
                        </label>
                        <input class="form-control" type="date" name="tgl_selesai" title="Isi Tanggal Selesai" required>
                    </div>
                    <div class="col-md-6">
                        <label for="" class="control-label modal-label">Output <span class="text-danger">*</span>
                        </label>
                        <input class="form-control" type="text" name="output" title="Isi Output" required>
                    </div>
                    <div class="col-md-6">
                        <label for="" class="control-label modal-label">Ketua Pelaksana <span
                                class="text-danger">*</span> </label>
                        <input class="form-control" type="text" name="ketua" title="Isi Ketua Pelaksana" required>
                    </div>
                    <div class="col-md-12">
                        <label for="" class="control-label modal-label">Lampiran<span class="text-danger"></span>
                        </label>
...
<!-- Modal Rencana -->
<div class="modal fade" id="modalRencana" tabindex="-1" role="dialog" aria-labelledby="dataDiriModalTitle"
    aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="itemkeuangan">
                <div class="col-md-12" style="padding-bottom:30px;">
                    <button onclick="tambahItem('test')" class="btn btn-success btn-fill pull-right" type="button"
                        name="button" id="btnitemkeuangan">Tambah Item</button>
                    <button onclick="hapusItemSemua()" class="btn btn-danger btn-fill pull-right"
                        style="margin-right:10px;" type="button" name="button" id="hpsitemsemua">Hapus Semua</button>
                </div>
                <br><br>
...
<div class="modal fade" id="modalDaftarRencana" tabindex="-1" role="dialog" aria-labelledby="dataDiriModalTitle"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" style="width:90vw;" role="document">
        <div class="modal-content">
...
<!-- Modal Buat LPJ -->
<div class="modal fade" id="modalBuatLPJ" tabindex="-1" role="dialog" aria-labelledby="dataDiriModalTitle"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" style="width:90vw;" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button onclick="tambahItemFisik()" class="btn btn-success btn-fill pull-left" type="button"
                    name="button" id="btnitemfisik">Tambah Item Fisik</button>
                <!-- </div> -->
                <button type="button" class="btn btn-danger btn-fill" data-dismiss="modal">Tutup</button>
                  ...
                  foreach ($itembarang as $i) {
                    ?>
                        <tr>
                            <th><?=$n++?></th>
                            <th><?=$i->uraian?></th>
                            <th><input type="number" id="item<?=$n?>-qty" name="jumlah" onclick="select()"
                                    class="form-control text-center" min="1" value="1" required autocomplete="off" />
                            </th>
                            <th><?=($i->tipe==1?'Belanja Barang/Jasa':'')?><?=($i->tipe==2?'Belanja Modal':'')?></th>
                            <th><?=$i->satuan?></th>
                            <th><?=$i->hst?></th>
                            <th style="text-align: right;">
                                <button id="item<?=$n?>" data-kode="<?=$i->kode?>" data-uraian="<?=$i->uraian?>"
                                    data-satuan="<?=$i->satuan?>" data-tipe="<?=$i->tipe?>" data-hst="<?=$i->hst?>"
                                    onclick="pilihItem(this.id, '<?=$kode_kegiatan?>')"
...
<footer class="sticky-footer bg-white">
    <div class="container my-auto">
        <div class="copyright text-center my-auto">
            <span>Copyright &copy; Kelurahan Palmerah <?= date('Y'); ?></span>
        </div>
    </div>
</footer>
<!-- End of Footer -->
    ...
    if (saveButton) {
        saveButton.addEventListener("click", function(event) {
            ...
            if (signaturePad.isEmpty()) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url();?>dashboard/surat/sign",
                    data: {
...
function lihatRencana() {
    ...
    $('#lihatitemkeuangan').append(
        `<div class="row"><div class="col-md-2 pull-right" id="totalharga""><h4 for="" >Total: ${total}</h4></div></div>`
    );
